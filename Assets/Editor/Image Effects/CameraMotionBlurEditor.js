...
{	
  ...
  var thisPreview : SerializedProperty;
  ...
  //var dynamicLayers : SerializedProperty;
    ...
    thisPreview = serObj.FindProperty ("preview");
  ...
  function OnInspectorGUI () {         
    ...
    EditorGUILayout.PropertyField (thisPreview, new GUIContent("Preview"));
    if (thisPreview.boolValue)
